...
const frontEndUrl = 'https://ayw-groep-02.netlify.app'
...
app.post('/api/new', async (req, res) => {
    ...
    if (isValidEmail(userEmail) === true) {
        ...
        const emailContent = `
            ...
            <a href="${frontEndUrl}/nieuwsbrief/bevestig?token=${verification_token}&type=${request_type}">Verify Email here</a>
        `;  
        ...
        if (user) {
          ...
          if (user.confirmed === true) {
            ...
            const emailContent = `
              ...
              <a href="${frontEndUrl}/nieuwsbrief/bevestig?token=${user.verification_token}&type=${request_type}">Verify Email here</a>
            `;
